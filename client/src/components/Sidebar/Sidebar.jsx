...
export default function Sidebar({ conversations, selectedId, onSelect, onOpenSettings, onNewGroup, onNewChat, onOpenNewChatPanel, onOpenInvitePanel }) {
  const { user } = useAuth();
  
  return (
    <div className="sidebar">
      <div className="sidebar-header">
        <div className="user-avatar-mini" onClick={onOpenSettings}>
          {user?.avatar_url ? (
        ...
        <div className="sidebar-actions">
          <button onClick={onOpenInvitePanel} title="Invite Friends">
